...
export default function CalculationsPage() {
  ...
  const {
    ...
    staleTime: Number.POSITIVE_INFINITY, // Settings rarely change
  })
    ...
    <>
      ...
      <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300">
        <CardHeader>
          ...
          {scoringSettings && (
            <CardDescription>
              P<sub>Físico</sub> (máx {scoringSettings.physical.maxPoints}, mín {scoringSettings.physical.minPoints}), P
              <sub>Mental</sub> (máx {scoringSettings.mental.maxPoints}, mín {scoringSettings.mental.minPoints}), P
              <sub>Extras</sub> (máx {scoringSettings.extras.capMax}, mín {scoringSettings.extras.capMin}). P
              <sub>Total</sub> = Suma.
            </CardDescription>
          )}
        </CardHeader>
